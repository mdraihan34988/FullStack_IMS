document.addEventListener('DOMContentLoaded', function(){
  document.getElementsByClassName("spinner").click();
  document.getElementsByClassName("spinner").animate({transform: 'transform: rotate(90.90deg) translateZ(0px)'});
...
var a = document.getElementsByClassName("spinner")[0],
	b = document.getElementById("avgrpm"),
...
function bootStart(){
  ...
  if(parseInt(c.innerHTML)>1){
    location.reload();
  }
}

var bootIntervalId = setInterval(bootStart, 800);
